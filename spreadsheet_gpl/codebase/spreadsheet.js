...
function placeRightOrLeft(pos, config) {
    ...
    if (leftDiff < 0 && rightDiff < 0) {
        if (config.auto) {
            return placeRightOrLeft(pos, __assign(__assign({}, config), { mode: Position.bottom, auto: false }));
        }
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(24), __webpack_require__(46).setImmediate))
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(2);
var AddColumn_1 = __webpack_require__(88);
var AddRow_1 = __webpack_require__(89);
var DeleteColumn_1 = __webpack_require__(90);
var DeleteRow_1 = __webpack_require__(91);
var GroupAction_1 = __webpack_require__(92);
var GroupColAction_1 = __webpack_require__(93);
var GroupRowAction_1 = __webpack_require__(94);
var LockCell_1 = __webpack_require__(95);
var RemoveCellStyles_1 = __webpack_require__(96);
var SetCellFormat_1 = __webpack_require__(97);
var SetCellStyle_1 = __webpack_require__(98);
var SetCellValue_1 = __webpack_require__(99);
exports.actions = {
...
var customHTMLButton_1 = __webpack_require__(74);
var dhx_button_1 = __webpack_require__(75);
var iconButton_1 = __webpack_require__(76);
var imageButton_1 = __webpack_require__(77);
var imageButtonText_1 = __webpack_require__(78);
var input_1 = __webpack_require__(79);
var menuItem_1 = __webpack_require__(80);
var separator_1 = __webpack_require__(81);
var spacer_1 = __webpack_require__(82);
...
var DataCollection = /** @class */ (function () {
    ...
    DataCollection.prototype.copy = function (id, index, target, targetId) {
        ...
        if (target) {
            ...
            if (target.exists(id)) {
                target.add(__assign(__assign({}, this.getItem(id)), { id: newid }), index);
                return newid;
            }
            else {
        ...
        this.add(__assign(__assign({}, this.getItem(id)), { id: newid }), index);
        return newid;
    };
...
exports.content = {
    ...
    selectFilter: {
        ...
        ], column.$uniqueData.map(function (col) { return dom_1.el("option", { value: col[column.id] }, col[column.id]); }))); },
...
var helper_1 = __webpack_require__(21);
var itemfactory_1 = __webpack_require__(25);
var MenuBase_1 = __webpack_require__(26);
...
var Spreadsheet_1 = __webpack_require__(51);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(24), __webpack_require__(48)))
...
var ts_layout_1 = __webpack_require__(70);
var ts_toolbar_1 = __webpack_require__(20);
var ActionsManager_1 = __webpack_require__(22);
var context_1 = __webpack_require__(100);
var menu_1 = __webpack_require__(101);
var toolbar_1 = __webpack_require__(102);
var EditLine_1 = __webpack_require__(103);
var actions_1 = __webpack_require__(15);
var buffer_1 = __webpack_require__(104);
var CustomCsvDriver_1 = __webpack_require__(105);
var format_1 = __webpack_require__(16);
var main_1 = __webpack_require__(1);
var selection_1 = __webpack_require__(41);
var toolbar_2 = __webpack_require__(23);
var hotkeys_1 = __webpack_require__(106);
var en_1 = __webpack_require__(6);
var Selection_1 = __webpack_require__(109);
var types_1 = __webpack_require__(4);
var core_1 = __webpack_require__(2);
var Exporter_1 = __webpack_require__(111);
var XlsxDriver_1 = __webpack_require__(112);
var XlsxProxy_1 = __webpack_require__(113);
...
var html_1 = __webpack_require__(3);
var view_1 = __webpack_require__(8);
var ts_popup_1 = __webpack_require__(55);
var colorHelpers_1 = __webpack_require__(57);
var colors_1 = __webpack_require__(58);
...
var Colorpicker = /** @class */ (function (_super) {
    ...
    Colorpicker.prototype._getContent = function () {
        var view = this._pickerState.currentView === "palette" ? __spreadArrays([
            this._getGrayShades()
        ], (this._getPalette()), [
            dom_1.el(".dhx_custom_colors", [
                dom_1.el(".dhx_custom_colors_header", ["Custom colors", dom_1.el("span.hint", " (Right click to delete)")]),
                dom_1.el(".dhx_custom_palette.dhx_palette_row", __spreadArrays(this._getCells(this._pickerState.customColors, "custom_color_cell"), [
...
var Popup = /** @class */ (function (_super) {
    ...
    Popup.prototype.show = function (node, config, attached) {
        ...
        setTimeout(function () {
            ...
            var _b = html_1.fitPosition(node, __assign(__assign({}, config), { width: width, height: height })), left = _b.left, top = _b.top;
...
var html_1 = __webpack_require__(3);
var types_1 = __webpack_require__(17);
var CollectionStore_1 = __webpack_require__(62);
...
var templates_1 = __webpack_require__(66);
var TreeGridCollection_1 = __webpack_require__(69);
var types_1 = __webpack_require__(19);
var core_1 = __webpack_require__(2);
...
var Grid = /** @class */ (function (_super) {
    ...
    function Grid(container, config) {
        ...
        _this.config = __assign(__assign({}, _this._defConfig), config);
        _this._scroll = {
            top: 0,
            left: 0
        };
...
var dataHelpers_1 = __webpack_require__(38);
var helpers_1 = __webpack_require__(14);
var Cells_1 = __webpack_require__(67);
var FixedRows_1 = __webpack_require__(68);
function getFixedCols(config) {
    ...
    return Cells_1.getContent(__assign(__assign({}, config), { columns: columns, positions: __assign(__assign({}, config.positions), { xStart: 0, xEnd: config.splitAt }) }));
}
function getRenderConfig(obj, data, wrapperSizes) {
    ...
    return __assign(__assign({}, config), { data: data, scroll: obj._scroll, positions: positions, headerHeight: config.$headerLevel * config.headerRowHeight, footerHeight: 40, firstColId: config.columns[0].id, events: obj.events, currentColumns: config.columns.slice(positions.xStart, positions.xEnd), sortBy: obj._sortBy, sortDir: obj._sortDir });
}
...
function getFixedRows(config, rowsConfig) {
    ...
    var fixedCols = config.splitAt >= 0 && FixedRows_1.getRows(__assign(__assign({}, config), { currentColumns: config.columns.slice(0, config.splitAt), positions: __assign(__assign({}, config.positions), { xStart: 0, xEnd: config.splitAt }) }), rowsConfig);
    var styles = (_a = {
            position: "sticky"
        },
    ...
    return dom_1.el(".dhx_" + rowsConfig.name + "_wrapper", {
        ...
        style: __assign(__assign({}, styles), { left: rowsConfig.sticky ? left : 0, height: config[rowsConfig.name + "Height"], width: rowsConfig.sticky ? config.$totalWidth : rowsConfig.wrapper.width - 2, zIndex: 9999 })
    }, [
...
function getRows(config, rowsConfig) {
    ...
    return rows.map(function (row, rowInd) { return dom_1.el(".dhx_" + rowName + "_row", { style: { height: rowHeight } }, row.map(function (cell, i) {
        ...
        return dom_1.el(".dhx_grid_" + rowName + "_cell", __assign(__assign({ "class": css, "dhx_id": column.id, "_key": i, "style": {
                width: column.width,
                lineHeight: rowHeight + "px"
...
var TreeGridCollection = /** @class */ (function (_super) {
    ...
    TreeGridCollection.prototype.serialize = function () {
        ...
        this.eachChild(this.getRoot(), function (el) {
            ...
            var cell = __assign(__assign({}, el), { $level: _this.getLevel(el.id), $childs: _this.haveChilds(el.id) });
...
var Cell = /** @class */ (function (_super) {
    ...
    Cell.prototype.toVDOM = function (nodes) {
        ...
        var resizer = this.config.canResize && !this._isLastCell() ?
            dom_1.el(".resizer." + (this._isXDirection() ? "x" : "y"), __assign(__assign({}, this._resizerHandlers), { _ref: "resizer_" + this._uid }), [dom_1.el("div", {
        ...
        var cell = dom_1.el("div", __assign(__assign({ _key: this._uid, style: style, _ref: this._uid }, handlers), { class: "dhx_cell " + css + (this.config.collapsed ? " collapsed" : "") }), [
...
var AddColumn = /** @class */ (function () {
    ...
    AddColumn.prototype.do = function () {
        ...
        var copy = __assign(__assign({}, this.config.grid.config.columns[1]), { $cellCss: {}, header: [{ text: "" }] });
        copy.id = core_1.uid();
...
var DeleteColumn = /** @class */ (function () {
    ...
    DeleteColumn.prototype.do = function () {
        ...
        if (this.config.grid.config.columns.length <= 1) {
            var copy = __assign(__assign({}, this._column), { $cellCss: {}, header: [{ text: "" }] });
            copy.id = core_1.uid();
    ...
    GroupAction.prototype.do = function () {
        ...
        if (!this._actions.length) {
            ...
            this.config.spreadsheet.eachCell(function (cell) {
                ...
                var action = new ActionsManager_1.actions[_this.config.action](__assign(__assign({}, _this.config), { row: row, col: col, cell: cell, val: val_1 }));
...
var SetCellStyle = /** @class */ (function () {
    ...
    SetCellStyle.prototype.do = function () {
        ...
        if (typeof this.config.val !== "string") {
            ...
            var css = dhx.css.add(__assign(__assign({}, styles), this.config.val));
            this.config.val = css;
        }
        var val = this.config.val;
...
var _this = this;
Object.defineProperty(exports, "__esModule", { value: true });
var Keymanager_1 = __webpack_require__(107);
...
var Selection = /** @class */ (function () {
    ...
    Selection.prototype._setGroupSelectionHandlers = function () {
        ...
        this._grid.events.on(ts_grid_1.GridEvents.cellMouseOver, function (row, col) {
            ...
            if (_this._mousePressed) {
                ...
                var selected = __spreadArrays(_this._selected);
    ...
    Selection.prototype._setHandlers = function () {
        ...
        this._events.on(types_1.SpreadsheetEvents.gridRedraw, function (vm) {
            ...
            vm.refs.selection.patch(dom_1.el(".dhx_grid_selection", __spreadArrays([
                copySelection,
                focusedCell
            ], selectedCells, [
                resizedLine,
            ...
            Object.keys(row).map(function (cell) {
                ...
                if (row.$info && row.$info[cell]) {
                    ...
                    if (styleInd === -1) {
                        ...
                        styles.push(__assign(__assign({ format: format }, exportStyles), { id: styleId_1 }));
